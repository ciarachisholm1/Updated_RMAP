...
NOTE: If the FITS files being used utilize plate carrée projection, please ensure the reference pixel for galactic latitude is $0\degree$ to avoid a skew in the longitude coordinates. See section 2.8 from Calabretta et al. 2004 for details. This applies to all recent FITS reading programs, not just the RMAP program.
